...
public class AdapterSubratesList  extends BaseAdapter {

    ArrayList<ModelSubscription> subrateArrayList;
    Context context;
    LayoutInflater inflater;
    FragmentSubList subratefragment;
    ActivityWelcome activityWelcome;

    public AdapterSubratesList(ArrayList<ModelSubscription> subrateArrayList, Context context) {
        this.activityWelcome = (ActivityWelcome)context;
        this.subrateArrayList = subrateArrayList;
        this.context = context;
        this.inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);

        subratefragment = (FragmentSubList) activityWelcome.getSupportFragmentManager().getFragments().get(0);
    }
    ...
    private void requestSubscription(String subid){
        ...
        subratefragment.progressBar.setVisibility(View.VISIBLE);
        String imei = subratefragment.globalVariable.getImei();
                ...
                try {
                    ...
                    if (!responseObj.getBoolean("ERROR")){
                        ...
                        if (strResponseCode.equals(ClassCommon.SUCCESS)) {
                            ...
                            AlertDialog.Builder builder = new AlertDialog.Builder(context);
                            String msgString = String.format(context.getString(R.string.subscription_pending), subratefragment.globalVariable.getSupportphone());
                            ...
                            builder.show();
                            subratefragment.progressBar.setVisibility(View.GONE);
